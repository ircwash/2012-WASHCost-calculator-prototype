...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.formula_variable'
        db.add_column('question_question', 'formula_variable',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Question.formula_variable'
        db.delete_column('question_question', 'formula_variable')
